...
export function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top_left,#dff1ff,transparent_32%),radial-gradient(circle_at_bottom_right,#d8fff0,transparent_28%),linear-gradient(135deg,#081a33,#102a52_45%,#0f766e)] p-5">
      <div className="mx-auto flex min-h-[calc(100vh-40px)] max-w-7xl items-center justify-center">
        <div className="grid w-full overflow-hidden rounded-[2rem] border border-white/70 bg-white/95 shadow-panel backdrop-blur-xl xl:grid-cols-[0.9fr_1.1fr]">
          <div className="relative overflow-hidden bg-slate-950 p-8 text-white lg:p-12">
            ...
            <div className="relative">
              <div className="mb-10 flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-2xl font-black">Diagnosis Center</h1>
                ...
                <div className="mt-4 grid gap-3 sm:grid-cols-2 xl:grid-cols-1">
                  {ROLES.map((role) => (
                    <button
                      ...
                      className="group rounded-3xl border border-slate-200 bg-white p-5 text-left shadow-soft transition hover:-translate-y-1 hover:border-clinical-200 hover:bg-clinical-50 hover:shadow-lift"
                    >
